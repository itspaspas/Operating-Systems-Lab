 ...
 408:	89 d1                	mov    %edx,%ecx
{
 ...
 43b:	0f b6 92 54 08 00 00 	movzbl 0x854(%edx),%edx
 ...
 4a9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 514:	ff 24 85 fc 07 00 00 	jmp    *0x7fc(,%eax,4)
 ...
 620:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 625:	bb d3 07 00 00       	mov    $0x7d3,%ebx
...
free(void *ap)
{
 ...
 631:	a1 28 0b 00 00       	mov    0xb28,%eax
{
 ...
 66f:	5b                   	pop    %ebx
  freep = p;
 670:	a3 28 0b 00 00       	mov    %eax,0xb28
}
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
 677:	5d                   	pop    %ebp
 ...
 686:	72 ce                	jb     656 <free+0x26>
{
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 28 0b 00 00       	mov    %eax,0xb28
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 28 0b 00 00    	mov    0xb28,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70b:	3b 05 28 0b 00 00    	cmp    0xb28,%eax
 ...
 72e:	e8 fd fe ff ff       	call   630 <free>
  return freep;
 733:	8b 15 28 0b 00 00    	mov    0xb28,%edx
 ...
 75c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 75f:	89 15 28 0b 00 00    	mov    %edx,0xb28
}
 ...
 76f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 28 0b 00 00 2c 	movl   $0xb2c,0xb28
 777:	0b 00 00 
    base.s.size = 0;
 77a:	b8 2c 0b 00 00       	mov    $0xb2c,%eax
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 2c 0b 00 00 2c 	movl   $0xb2c,0xb2c
 786:	0b 00 00 
    base.s.size = 0;
 789:	c7 05 30 0b 00 00 00 	movl   $0x0,0xb30
 790:	00 00 00 
    if(p->s.size >= nunits){
