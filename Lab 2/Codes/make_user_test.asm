   ...
   e:	be a8 08 00 00       	mov    $0x8a8,%esi
{
  13:	53                   	push   %ebx
  printf(1, "Create user 1: %s\n", ret == 0 ? "SUCCESS" : "FAILED");
  14:	bb b0 08 00 00       	mov    $0x8b0,%ebx
{
  19:	51                   	push   %ecx
  1a:	83 ec 14             	sub    $0x14,%esp
  printf(1, "Creating users...\n");
  1d:	68 b7 08 00 00       	push   $0x8b7
  22:	6a 01                	push   $0x1
  24:	e8 77 05 00 00       	call   5a0 <printf>
  ret = make_user(1, "password1");
  29:	58                   	pop    %eax
  2a:	5a                   	pop    %edx
  2b:	68 ca 08 00 00       	push   $0x8ca
  30:	6a 01                	push   $0x1
  32:	e8 8c 04 00 00       	call   4c3 <make_user>
  printf(1, "Create user 1: %s\n", ret == 0 ? "SUCCESS" : "FAILED");
  37:	83 c4 0c             	add    $0xc,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	89 f0                	mov    %esi,%eax
  3e:	0f 45 c3             	cmovne %ebx,%eax
  41:	50                   	push   %eax
  42:	68 d4 08 00 00       	push   $0x8d4
  47:	6a 01                	push   $0x1
  49:	e8 52 05 00 00       	call   5a0 <printf>
  
  ret = make_user(2, "password2");
  4e:	59                   	pop    %ecx
  4f:	58                   	pop    %eax
  50:	68 e7 08 00 00       	push   $0x8e7
  55:	6a 02                	push   $0x2
  57:	e8 67 04 00 00       	call   4c3 <make_user>
  printf(1, "Create user 2: %s\n", ret == 0 ? "SUCCESS" : "FAILED");
  5c:	83 c4 0c             	add    $0xc,%esp
  5f:	85 c0                	test   %eax,%eax
  61:	89 f0                	mov    %esi,%eax
  63:	0f 45 c3             	cmovne %ebx,%eax
  66:	50                   	push   %eax
  67:	68 f1 08 00 00       	push   $0x8f1
  6c:	6a 01                	push   $0x1
  ...
  7a:	6a 01                	push   $0x1
  7c:	e8 42 04 00 00       	call   4c3 <make_user>
  printf(1, "Create duplicate user: %s (expected to fail)\n", ret == 0 ? "SUCCESS" : "FAILED");
  81:	83 c4 0c             	add    $0xc,%esp
  84:	85 c0                	test   %eax,%eax
  86:	89 f0                	mov    %esi,%eax
  88:	0f 45 c3             	cmovne %ebx,%eax
  8b:	50                   	push   %eax
  8c:	68 7c 09 00 00       	push   $0x97c
  91:	6a 01                	push   $0x1
  93:	e8 08 05 00 00       	call   5a0 <printf>
  
  printf(1, "\nTesting login...\n");
  98:	59                   	pop    %ecx
  99:	58                   	pop    %eax
  9a:	68 0e 09 00 00       	push   $0x90e
  9f:	6a 01                	push   $0x1
  ...
  a6:	58                   	pop    %eax
  a7:	5a                   	pop    %edx
  a8:	68 ca 08 00 00       	push   $0x8ca
  ad:	6a 01                	push   $0x1
  af:	e8 17 04 00 00       	call   4cb <login>
  printf(1, "Login user 1: %s\n", ret == 0 ? "SUCCESS" : "FAILED");
  b4:	83 c4 0c             	add    $0xc,%esp
  b7:	85 c0                	test   %eax,%eax
  b9:	89 f0                	mov    %esi,%eax
  bb:	0f 45 c3             	cmovne %ebx,%eax
  be:	50                   	push   %eax
  ...
  cb:	59                   	pop    %ecx
  cc:	58                   	pop    %eax
  cd:	68 e7 08 00 00       	push   $0x8e7
  d2:	6a 02                	push   $0x2
  d4:	e8 f2 03 00 00       	call   4cb <login>
  printf(1, "Login while logged in: %s (expected to fail)\n", ret == 0 ? "SUCCESS" : "FAILED");
  d9:	83 c4 0c             	add    $0xc,%esp
  dc:	85 c0                	test   %eax,%eax
  de:	89 f0                	mov    %esi,%eax
  e0:	0f 45 c3             	cmovne %ebx,%eax
  e3:	50                   	push   %eax
  e4:	68 ac 09 00 00       	push   $0x9ac
  e9:	6a 01                	push   $0x1
  eb:	e8 b0 04 00 00       	call   5a0 <printf>
  
  printf(1, "\nGetting system call log for current user...\n");
  f0:	58                   	pop    %eax
  f1:	5a                   	pop    %edx
  f2:	68 dc 09 00 00       	push   $0x9dc
  f7:	6a 01                	push   $0x1
  f9:	e8 a2 04 00 00       	call   5a0 <printf>
  get_log();
  fe:	e8 d8 03 00 00       	call   4db <get_log>
  
  printf(1, "\nTesting logout...\n");
 103:	59                   	pop    %ecx
 104:	58                   	pop    %eax
 105:	68 33 09 00 00       	push   $0x933
 10a:	6a 01                	push   $0x1
 10c:	e8 8f 04 00 00       	call   5a0 <printf>
  ret = logout();
 111:	e8 bd 03 00 00       	call   4d3 <logout>
  printf(1, "Logout: %s\n", ret == 0 ? "SUCCESS" : "FAILED");
 116:	83 c4 0c             	add    $0xc,%esp
 119:	85 c0                	test   %eax,%eax
 11b:	89 f0                	mov    %esi,%eax
 11d:	0f 45 c3             	cmovne %ebx,%eax
 120:	50                   	push   %eax
 121:	68 69 09 00 00       	push   $0x969
 126:	6a 01                	push   $0x1
 ...
 12d:	58                   	pop    %eax
 12e:	5a                   	pop    %edx
 12f:	68 47 09 00 00       	push   $0x947
 134:	6a 02                	push   $0x2
 136:	e8 90 03 00 00       	call   4cb <login>
  printf(1, "Login with wrong password: %s (expected to fail)\n", ret == 0 ? "SUCCESS" : "FAILED");
 13b:	83 c4 0c             	add    $0xc,%esp
 13e:	85 c0                	test   %eax,%eax
 140:	89 f0                	mov    %esi,%eax
 142:	0f 45 c3             	cmovne %ebx,%eax
 145:	50                   	push   %eax
 146:	68 0c 0a 00 00       	push   $0xa0c
 14b:	6a 01                	push   $0x1
 ...
 152:	59                   	pop    %ecx
 153:	58                   	pop    %eax
 154:	68 e7 08 00 00       	push   $0x8e7
 159:	6a 02                	push   $0x2
 15b:	e8 6b 03 00 00       	call   4cb <login>
  printf(1, "Login user 2: %s\n", ret == 0 ? "SUCCESS" : "FAILED");
 160:	83 c4 0c             	add    $0xc,%esp
 163:	85 c0                	test   %eax,%eax
 165:	89 f0                	mov    %esi,%eax
 167:	0f 45 c3             	cmovne %ebx,%eax
 16a:	50                   	push   %eax
 16b:	68 56 09 00 00       	push   $0x956
 170:	6a 01                	push   $0x1
 172:	e8 29 04 00 00       	call   5a0 <printf>

  printf(1, "\nGetting system call log for user 2...\n");
 177:	58                   	pop    %eax
 178:	5a                   	pop    %edx
 179:	68 40 0a 00 00       	push   $0xa40
 17e:	6a 01                	push   $0x1
 180:	e8 1b 04 00 00       	call   5a0 <printf>
  get_log();
 185:	e8 51 03 00 00       	call   4db <get_log>

  ret = logout();
 18a:	e8 44 03 00 00       	call   4d3 <logout>
  printf(1, "\nLogout: %s\n", ret == 0 ? "SUCCESS" : "FAILED");
 18f:	83 c4 0c             	add    $0xc,%esp
 192:	85 c0                	test   %eax,%eax
 194:	0f 44 de             	cmove  %esi,%ebx
 197:	53                   	push   %ebx
 198:	68 68 09 00 00       	push   $0x968
 19d:	6a 01                	push   $0x1
 19f:	e8 fc 03 00 00       	call   5a0 <printf>
  
  printf(1, "\nGetting global system call log...\n");
 1a4:	59                   	pop    %ecx
 1a5:	5b                   	pop    %ebx
 1a6:	68 68 0a 00 00       	push   $0xa68
 1ab:	6a 01                	push   $0x1
 1ad:	e8 ee 03 00 00       	call   5a0 <printf>
  get_log();
 1b2:	e8 24 03 00 00       	call   4db <get_log>
  
  printf(1, "\nUser management test complete.\n");
 1b7:	5e                   	pop    %esi
 1b8:	58                   	pop    %eax
 1b9:	68 8c 0a 00 00       	push   $0xa8c
 1be:	6a 01                	push   $0x1
 1c0:	e8 db 03 00 00       	call   5a0 <printf>
  ret = login(1, "password1");
 1c5:	58                   	pop    %eax
 1c6:	5a                   	pop    %edx
 1c7:	68 ca 08 00 00       	push   $0x8ca
 1cc:	6a 01                	push   $0x1
 1ce:	e8 f8 02 00 00       	call   4cb <login>
  get_log();
 1d3:	e8 03 03 00 00       	call   4db <get_log>
  exit();
 1d8:	e8 46 02 00 00       	call   423 <exit>
 ...
 508:	89 d1                	mov    %edx,%ecx
{
 ...
 53b:	0f b6 92 08 0b 00 00 	movzbl 0xb08(%edx),%edx
 ...
 5a9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 614:	ff 24 85 b0 0a 00 00 	jmp    *0xab0(,%eax,4)
 ...
 720:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 725:	bb 75 09 00 00       	mov    $0x975,%ebx
...
free(void *ap)
{
 ...
 731:	a1 b0 0d 00 00       	mov    0xdb0,%eax
{
 ...
 76f:	5b                   	pop    %ebx
  freep = p;
 770:	a3 b0 0d 00 00       	mov    %eax,0xdb0
}
 775:	5e                   	pop    %esi
 776:	5f                   	pop    %edi
 777:	5d                   	pop    %ebp
 ...
 786:	72 ce                	jb     756 <free+0x26>
{
 ...
 7a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 7aa:	a3 b0 0d 00 00       	mov    %eax,0xdb0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7cc:	8b 15 b0 0d 00 00    	mov    0xdb0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 80b:	3b 05 b0 0d 00 00    	cmp    0xdb0,%eax
 ...
 82e:	e8 fd fe ff ff       	call   730 <free>
  return freep;
 833:	8b 15 b0 0d 00 00    	mov    0xdb0,%edx
 ...
 85c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 85f:	89 15 b0 0d 00 00    	mov    %edx,0xdb0
}
 ...
 86f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 870:	c7 05 b0 0d 00 00 b4 	movl   $0xdb4,0xdb0
 877:	0d 00 00 
    base.s.size = 0;
 87a:	b8 b4 0d 00 00       	mov    $0xdb4,%eax
    base.s.ptr = freep = prevp = &base;
 87f:	c7 05 b4 0d 00 00 b4 	movl   $0xdb4,0xdb4
 886:	0d 00 00 
    base.s.size = 0;
 889:	c7 05 b8 0d 00 00 00 	movl   $0x0,0xdb8
 890:	00 00 00 
    if(p->s.size >= nunits){
