...
_brace_check:     file format elf32-i386
...
int main(int argc, char *argv[]) {
  ...
  int fd = open("result.txt", O_CREATE | O_WRONLY);
  48:	e8 26 03 00 00       	call   373 <open>
  if (fd < 0) {
  ...
  58:	75 1f                	jne    79 <main+0x79>
    write(fd, "Right\n", 6);
  } else {
    write(fd, "Wrong\n", 6);
  5a:	50                   	push   %eax
  5b:	6a 06                	push   $0x6
  5d:	68 ac 07 00 00       	push   $0x7ac
  62:	53                   	push   %ebx
  63:	e8 eb 02 00 00       	call   353 <write>
  ...
  6e:	53                   	push   %ebx
  6f:	e8 e7 02 00 00       	call   35b <close>
  exit();
  74:	e8 ba 02 00 00       	call   333 <exit>
    write(fd, "Right\n", 6);
  79:	52                   	push   %edx
  7a:	6a 06                	push   $0x6
  7c:	68 a5 07 00 00       	push   $0x7a5
  81:	50                   	push   %eax
  82:	e8 cc 02 00 00       	call   353 <write>
  87:	83 c4 10             	add    $0x10,%esp
  8a:	eb df                	jmp    6b <main+0x6b>
    printf(1, "Error: Cannot open result.txt\n");
  8c:	51                   	push   %ecx
  8d:	51                   	push   %ecx
  ...
  95:	e8 e6 03 00 00       	call   480 <printf>
    exit();
  9a:	e8 94 02 00 00       	call   333 <exit>
  9f:	90                   	nop

000000a0 <check_braces>:
int check_braces(char *str) {
  ...
  a9:	84 c0                	test   %al,%al
  ab:	74 3c                	je     e9 <check_braces+0x49>
  ad:	83 c2 01             	add    $0x1,%edx
  int stack_count = 0;
  b0:	31 c9                	xor    %ecx,%ecx
  b2:	eb 12                	jmp    c6 <check_braces+0x26>
  b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    } else if (str[i] == '}') {
  b8:	3c 7d                	cmp    $0x7d,%al
  ba:	74 24                	je     e0 <check_braces+0x40>
  for (int i = 0; str[i] != '\0'; i++) {
  bc:	0f b6 02             	movzbl (%edx),%eax
  bf:	83 c2 01             	add    $0x1,%edx
  c2:	84 c0                	test   %al,%al
  c4:	74 11                	je     d7 <check_braces+0x37>
    if (str[i] == '{') {
  c6:	3c 7b                	cmp    $0x7b,%al
  c8:	75 ee                	jne    b8 <check_braces+0x18>
  for (int i = 0; str[i] != '\0'; i++) {
  ca:	0f b6 02             	movzbl (%edx),%eax
  cd:	83 c2 01             	add    $0x1,%edx
      stack_count++;
  d0:	83 c1 01             	add    $0x1,%ecx
  for (int i = 0; str[i] != '\0'; i++) {
  d3:	84 c0                	test   %al,%al
  d5:	75 ef                	jne    c6 <check_braces+0x26>
  return stack_count == 0; 
  d7:	31 c0                	xor    %eax,%eax
  d9:	85 c9                	test   %ecx,%ecx
}
  db:	5d                   	pop    %ebp
  return stack_count == 0; 
  dc:	0f 94 c0             	sete   %al
  ...
  df:	c3                   	ret
      if (stack_count < 0) {
  e0:	83 e9 01             	sub    $0x1,%ecx
  e3:	79 d7                	jns    bc <check_braces+0x1c>
        return 0;
 ...
 3e8:	89 d1                	mov    %edx,%ecx
{
 ...
 41b:	0f b6 92 34 08 00 00 	movzbl 0x834(%edx),%edx
 ...
 489:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4f4:	ff 24 85 dc 07 00 00 	jmp    *0x7dc(,%eax,4)
 ...
 600:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 605:	bb b3 07 00 00       	mov    $0x7b3,%ebx
...
free(void *ap)
{
 ...
 611:	a1 08 0b 00 00       	mov    0xb08,%eax
{
 ...
 64f:	5b                   	pop    %ebx
  freep = p;
 650:	a3 08 0b 00 00       	mov    %eax,0xb08
}
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 657:	5d                   	pop    %ebp
 ...
 666:	72 ce                	jb     636 <free+0x26>
{
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 08 0b 00 00       	mov    %eax,0xb08
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 08 0b 00 00    	mov    0xb08,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6eb:	3b 05 08 0b 00 00    	cmp    0xb08,%eax
 ...
 70e:	e8 fd fe ff ff       	call   610 <free>
  return freep;
 713:	8b 15 08 0b 00 00    	mov    0xb08,%edx
 ...
 73c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 73f:	89 15 08 0b 00 00    	mov    %edx,0xb08
}
 ...
 74f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 08 0b 00 00 0c 	movl   $0xb0c,0xb08
 757:	0b 00 00 
    base.s.size = 0;
 75a:	b8 0c 0b 00 00       	mov    $0xb0c,%eax
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 0c 0b 00 00 0c 	movl   $0xb0c,0xb0c
 766:	0b 00 00 
    base.s.size = 0;
 769:	c7 05 10 0b 00 00 00 	movl   $0x0,0xb10
 770:	00 00 00 
    if(p->s.size >= nunits){
